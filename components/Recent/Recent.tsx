...
const Recent = ({animeId, animeTitle, episodeNum, animeImg, episodeId }: RecentProps) => {
  return (
    <Link id="recent" href={`/watch/${episodeId}?animeID=${animeId}&episodeNumber=${episodeNum}`} className="keen-slider__slide -mr-8  flex flex-col justify-center items-center">
